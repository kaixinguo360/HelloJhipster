package com.my.list.repository;

import com.my.list.MyListApp;
import com.my.list.config.Constants;
import com.my.list.config.audit.AuditEventConverter;
import com.my.list.domain.PersistentAuditEvent;
...
import static com.my.list.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
