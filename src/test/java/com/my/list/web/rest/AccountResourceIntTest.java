package com.my.list.web.rest;

import com.my.list.MyListApp;
import com.my.list.config.Constants;
import com.my.list.domain.Authority;
import com.my.list.domain.User;
import com.my.list.repository.AuthorityRepository;
import com.my.list.repository.UserRepository;
import com.my.list.security.AuthoritiesConstants;
import com.my.list.service.MailService;
import com.my.list.service.UserService;
import com.my.list.service.dto.PasswordChangeDTO;
import com.my.list.service.dto.UserDTO;
import com.my.list.web.rest.errors.ExceptionTranslator;
import com.my.list.web.rest.vm.KeyAndPasswordVM;
import com.my.list.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = MyListApp.class)
