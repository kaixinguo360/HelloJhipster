...
import com.my.list.domain.Tag;
import com.my.list.repository.TagRepository;
...
import static com.my.list.web.rest.TestUtil.createFormattingConversionService;
...
public class TagResourceIntTest {
    ...
    public void createTag() throws Exception {
        ...
        assertThat(testTag.getInfo()).isEqualTo(DEFAULT_INFO);
    }
    ...
    public void updateTag() throws Exception {
        ...
        assertThat(testTag.getInfo()).isEqualTo(UPDATED_INFO);
    }
